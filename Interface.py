...
total = Label(contour, text='Total : '+prix).place(anchor = SW)
...
matable.column("nom", anchor=CENTER, width=80)
matable.column("qte",anchor=CENTER, width=80)
matable.column("prix",anchor=CENTER,width=80)
matable.column("prixtot",anchor=CENTER,width=100)
